...
@start python.exe "C:\SPIM\Common\Calculations\Python\Phase Retrieval ML\opticalaberrations\src\ao.py" aggregate_predictions %mypath%\%fileA%_tiles_predictions.csv ../calibration/aang/15_mode_calibration.csv --current_dm \\AANG\opticalaberrations\examples\DM_State_510nm.csv --plot
@start python.exe "C:\SPIM\Common\Calculations\Python\Phase Retrieval ML\opticalaberrations\src\ao.py" aggregate_predictions %mypath%\%fileB%_tiles_predictions.csv ../calibration/aang/15_mode_calibration.csv --current_dm \\AANG\opticalaberrations\examples\DM_State_510nm.csv --plot
@python.exe "C:\SPIM\Common\Calculations\Python\Phase Retrieval ML\opticalaberrations\src\ao.py" aggregate_predictions %mypath%\%fileC%_tiles_predictions.csv ../calibration/aang/15_mode_calibration.csv --current_dm \\AANG\opticalaberrations\examples\DM_State_510nm.csv --plot
@python.exe "C:\SPIM\Common\Calculations\Python\Phase Retrieval ML\opticalaberrations\src\ao.py" aggregate_predictions %mypath%\%fileD%_tiles_predictions.csv ../calibration/aang/15_mode_calibration.csv --current_dm \\AANG\opticalaberrations\examples\DM_State_510nm.csv --plot
