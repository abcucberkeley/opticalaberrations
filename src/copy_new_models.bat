...
echo Add metadata
echo for Model 1020
C:\Users\Aang\miniconda3\envs\ml\python.exe "C:\SPIM\Common\Calculations\Python\Phase Retrieval ML\opticalaberrations\src\predict.py" ../pretrained_models/opticalnet-15-YuMB-lambda510.h5 --psf_type ../lattice/YuMB_NAlattice0.35_NAAnnulusMax0.40_NAsigma0.1.mat --n_modes 15 --wavelength .510 --x_voxel_size .097 --y_voxel_size .097 --z_voxel_size .2 --embedding_option spatial_planes1020 metadata
echo:
echo for Model 20
C:\Users\Aang\miniconda3\envs\ml\python.exe "C:\SPIM\Common\Calculations\Python\Phase Retrieval ML\opticalaberrations\src\predict.py" ../pretrained_models/opticalnet-15-YuMB-lambda510.h5   --psf_type ../lattice/YuMB_NAlattice0.35_NAAnnulusMax0.40_NAsigma0.1.mat --n_modes 15 --wavelength .510 --x_voxel_size .097 --y_voxel_size .097 --z_voxel_size .2 --embedding_option spatial_planes20 metadata
echo:
echo for Model 10
C:\Users\Aang\miniconda3\envs\ml\python.exe "C:\SPIM\Common\Calculations\Python\Phase Retrieval ML\opticalaberrations\src\predict.py" ../pretrained_models/opticalnet-15-YuMB-lambda510.h5   --psf_type ../lattice/YuMB_NAlattice0.35_NAAnnulusMax0.40_NAsigma0.1.mat --n_modes 15 --wavelength .510 --x_voxel_size .097 --y_voxel_size .097 --z_voxel_size .2 --embedding_option spatial_planes10 metadata
