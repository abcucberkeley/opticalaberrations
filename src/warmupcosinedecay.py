...
@keras_export(
    "keras.optimizers.schedules.WarmupCosineDecay",
    "keras.experimental.WarmupCosineDecay"
)
class WarmupCosineDecay(LearningRateSchedule):
    """
    A LearningRateSchedule that uses a cosine decay with optional warmup.
    https://github.com/keras-team/keras/blob/v2.14.0/keras/optimizers/schedules/learning_rate_schedule.py#L581
    ...
    lr_warmup_decayed_fn = tf.keras.optimizers.schedules.WarmupCosineDecay(
