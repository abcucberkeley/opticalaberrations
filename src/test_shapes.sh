...
do
  ...
  do
    for REF in 'single_point' 'two_points' 'five_points' 'several_points' 'line' 'sheet' 'sphere' 'cylinder' 'point_and_line' 'point_and_sheet' 'point_and_cylinder' 'several_points_and_line' 'several_points_and_sheet' 'several_points_and_cylinder'
    do
