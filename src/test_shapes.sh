...
do
  ...
  do
    #for REF in 'single_point' 'two_points' 'several_points' 'cube' 'sheet' 'cylinder' 'point_and_sheet' 'point_and_cylinder' 'several_points_and_sheet' 'several_points_and_cylinder'
    for REF in 'single_point' 'two_points' 'several_points'
    do
