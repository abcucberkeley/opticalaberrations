...
![python](https://img.shields.io/badge/Python-3.8+-3776AB.svg?style=flat&logo=python&logoColor=white) ![tensorflow](https://img.shields.io/badge/TensorFlow-2.5+-FF6F00.svg?style=flat&logo=tensorflow) ![license](https://img.shields.io/github/license/abcucberkeley/opticalaberrations.svg) ![issues](https://img.shields.io/github/issues/abcucberkeley/opticalaberrations.svg) ![pr](https://img.shields.io/github/issues-pr/abcucberkeley/opticalaberrations.svg)


|  | ![Ubuntu](https://img.shields.io/badge/Ubuntu-E95420?style=for-the-badge&logo=ubuntu&logoColor=white)                                         | ![Windows](https://img.shields.io/badge/Windows-0078D6?style=for-the-badge&logo=windows&logoColor=white)                                        | ![MacOS](https://img.shields.io/badge/mac%20os-000000?style=for-the-badge&logo=apple&logoColor=white)                                       |
|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| `main`    | ![Ubuntu-master](https://github.com/abcucberkeley/opticalaberrations/actions/workflows/ubuntu-build.yaml/badge.svg?event=push)                | ![Windows-master](https://github.com/abcucberkeley/opticalaberrations/actions/workflows/windows-build.yaml/badge.svg?event=push)                | ![MacOS-master](https://github.com/abcucberkeley/opticalaberrations/actions/workflows/macos-build.yaml/badge.svg?event=push)                |
| `develop` | ![Ubuntu-master](https://github.com/abcucberkeley/opticalaberrations/actions/workflows/ubuntu-build.yaml/badge.svg?branch=develop&event=push) | ![Windows-master](https://github.com/abcucberkeley/opticalaberrations/actions/workflows/windows-build.yaml/badge.svg?branch=develop&event=push) | ![MacOS-master](https://github.com/abcucberkeley/opticalaberrations/actions/workflows/macos-build.yaml/badge.svg?branch=develop&event=push) |
